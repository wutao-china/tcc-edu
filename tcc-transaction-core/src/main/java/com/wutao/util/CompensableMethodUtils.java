...
public class CompensableMethodUtils {
    ...
    public static int getTransactionContextParamPosition(Class<?>[] parameterTypes) {
        ...
        for (i = 0; i < parameterTypes.length; i++) {
            if (parameterTypes[i].equals(com.wutao.api.TransactionContext.class)) {
                break;
            }
        }
        return i;
    ...
    public static TransactionContext getTransactionContextFromArgs(Object[] args) {
        ...
        for (Object arg : args) {
            if (arg != null && com.wutao.api.TransactionContext.class.isAssignableFrom(arg.getClass())) {

                transactionContext = (com.wutao.api.TransactionContext) arg;
            }
        }
